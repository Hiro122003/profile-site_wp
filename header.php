        ...
        <nav class="hd-nav">
          <ul class="hd-nav-list">
            <li class="hd-nav-item">
              <a href="/about/" class="hd-nav-link"><span>About</span></a>
            </li>
            <li class="hd-nav-item">
              <a href="/skills/" class="hd-nav-link"><span>Skills</span></a>
            </li>
            <li class="hd-nav-item">
              <a href="/news/" class="hd-nav-link"><span>News</span></a>
            </li>
            <li class="hd-nav-item contact-item">
              <a href="/contact/" class="hd-nav-link contact-form"><span>Contact</span></a>
            </li>
          </ul>
        </nav>
      ...
      <div class="p-sp-menu">
        <ul class="p-sp-menu__list">
          <li class="p-sp-menu__item">
            <a href="/about/" class="p-sp-menu__link"><span>About</span></a>
          </li>
          <li class="p-sp-menu__item">
            <a href="/skills/" class="p-sp-menu__link"><span>Skills</span></a>
          </li>
          <li class="p-sp-menu__item">
            <a href="/news/" class="p-sp-menu__link"><span>News</span></a>
          </li>
          <li class="p-sp-menu__item p-sp-menu__item--contact">
            <a href="/contact/" class="p-sp-menu__link p-sp-menu__link--contact-btn"><span>Contact</span></a>
          </li>
        </ul>
      </div>
    </div>